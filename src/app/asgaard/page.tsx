...
<div className='flex-1 space-y-5'>
    ...
    <h3 className='text-5xl font-semibold text-black sm:text-2xl md:text-4xl'>Asgaard Sofa</h3>
  ...
  <p className="text-gray-600 mb-6 mt-6 sm:text-base">
    Setting the bar as one of the loudest speakers in its class, the Kilburn
     ...
     boasts a clear midrange and extended highs for a sound.</p>

        <div className='mb-4'>
            <h3 className='text-gray-400 font-semibold mb-2'>Size</h3>
            <div className='flex space-x-2'>
      <button  className='px-4 py-2 border rounded-lg bg-yellow-200'>L</button>
     <button  className='px-4 py-2 border rounded-lg bg-gray-100'>XL</button>
   <button  className='px-4 py-2 border rounded-lg bg-gray-100'>XS</button>
  </div>
   </div>
 ...
 <div className='mb-6'>
  <h3 className='text-gray-400 font-semibold mb-2'>Color</h3>
    ...
    <button className='w-8 h-8 rounded-full bg-yellow-600 border'></button></div>
            </div>
            <div className='flex items-center space-x-4 mb-5'>
  <button className='px-4 py-2 border rounded-lg'>-</button>
    <span className='text-lg font-semibold'>1</span>
    <button  className='px-4 py-2 border rounded-lg'>+</button>
      <button className='font-medium text-gray-900 border border-black px-14
  ...
  <span className='pl-4 text-gray-500'>: SS001</span>
      ...
      <span className='pl-4 text-gray-500'>: Sofa,Chair,Home,Shop</span>
 </div>
 ...
 <div className='flex justify-between items-center mt-5 '>
      ...
      <FaTwitterSquare size={28} className='cursor:pointer hover:text-gray-400'/>
      <IoIosHeartEmpty size={32} className='cursor:pointer text-red-700'/>
</div>
</div>
</div>
 </div>
 ...
 <>
         ...
         the unmistakable look and<br/> sound of Marshall,unplugs the chords, and takes the show on the road.
         </p>
         ...
         Weighing in under 7 pounds, the Kilburn is a lightweight piece of vintage styled engineering. Setting
          the bar as one of the loudest<br/> speakers in its class, the Kilburn is a compact, stout-hearted hero with 
          a well-balanced audio which boasts a clear midrange<br/> and extended highs for a sound that is both articulate
          and pronounced. The analogue knobs allow you to fine tune the controls<br/> to your personal preferences while
      ...
      {/*RELATED PRODUCT*/}
        ...
        <h2 className='text-black text-3xl font-semibold sm:text-sm lg:text-4xl '>Related Products</h2>
     </div>
