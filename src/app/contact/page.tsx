    ...
    <div className="max-w-screen-xl container mx-auto pb-8 px-4">
      ...
      <div className="relative text-black">
        ...
        <div className="absolute top-28 left-1/2 transform -translate-x-1/3 -translate-y-1/3 mt-10">
          <p className="text-gray-700 text-xs md:text-xl flex items-center gap-2 mt-7">
      ...
      <section className="mt-16 text-center px-4 md:px-32">
        ...
        <p className="mt-4 text-lg text-gray-600">
          ...
          libero aut, reiciendis,voluptate rerum nemo non corporis esse
          aspernatur?
        </p>
      </section>
      ...
      <div className="flex flex-col md:flex-row justify-between mt-12 gap-12 md:gap-16">
        ...
        <div className="mt-16 bg-white rounded-lg p-8 md:w-1/2">
          <form className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-7 py-3  border rounded-sm focus:outline-none focus:ring-2 focus:ring-primary"
              />
            </div>
            <div>
              <label
              ...
              <input
                ...
                className="w-full px-7 py-4  border rounded-sm focus:outline-none focus:ring-2 focus:ring-primary"
              />
            </div>
            <div>
              <label
            ...
            <div>
              ...
              <textarea
                id="message"
                placeholder="Hello, you would like say or ask something......."
                rows={3}
                className="w-full px-7 py-4  border rounded-sm focus:outline-none focus:ring-2 focus:ring-primary"
              ></textarea>
            </div>
          ...
          <button
            type="submit"
            className="py-4 px-10 border border-black text-2xl rounded-none mt-8 hover:shadow-slate-600"
          >
            Submit
          </button>
        </div>
