  ...
  <div className="mt-10 w-full lg:w-1/4 p-6 gap-6">
    ...
    <div className="p-6 rounded-lg">
      ...
      <div className="space-y-6">
        {[
          { image: '/pimage2.jpeg', title: 'Going all-in with millennial design', date: '03 Aug 2022' },
          { image: '/pimage3.jpeg', title: 'Exploring new ways of decorating', date: '03 Aug 2022' },
          { image: '/b3pic.jpeg', title: 'Handmade pieces that took time to make', date: '03 Aug 2022' },
          { image: '/pimage1.jpeg', title: 'Modern home in Milan', date: '03 Aug 2022' },
          { image: '/pimage4.jpeg', title: 'Colorful office redesign', date: '03 Aug 2022' },
        ].map((post, index) => (
