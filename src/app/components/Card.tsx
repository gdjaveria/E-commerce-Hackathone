...
function ShoppingCart() {
  ...
  <div className="space-y-4">
     ...
     <div className="flex">
     <Image
         src="/Asgaardsofa.png" alt="Asgaard Sofa" height={150} width={150}                    
  ...
  <p>Subtotal</p>
   ...
   <hr />
    ...
    <Link href='/viewcart'>
         <button className="rounded-full text-black hover:text-white bg-white
          hover:bg-gray-800 px-8 py-2 border border-black">
           View Cart
     </button>
     </Link>
  <Link href='/checkout'>
 <button className="rounded-full text-black hover:text-white bg-white hover:bg-gray-800 px-8 py-2 border border-black">
  ...
  <button
     onClick={toggleCart}
    className="absolute top-4 right-4 text-gray-500 hover:text-gray-700"aria-label="Close Cart">
    Close
  </button>
 </div>
 </div>
